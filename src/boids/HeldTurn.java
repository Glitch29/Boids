 ...
 */
public final class HeldTurn implements PsyboidOverride {
    private final int onset;
    private final int duration;
    private final int direction;
    private final int psyboid;

    public HeldTurn(int onset, int duration, int direction, int psyboid) {
        this.onset = onset;
    ...
    static HeldTurn parseHeld(String label) {
        int turnAt = 1;
        ...
        return new HeldTurn(onset, duration, turn == 'L' ? -1 : turn == 'R' ? 1 : 0, psyboid);
    }
